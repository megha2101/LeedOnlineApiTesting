...
public class Get_Common_getTaxForAmountTest extends BaseClass{
	@Test
	@Parameters({"rowNum", "SheetName" })
	public void Get_Common_getTaxForAmount(int rowNum, String SheetName) throws IOException {
		try {	
			...
			CommonMethod.test =  CommonMethod.extent
					.startTest("Get_Common_getTaxForAmount Api "+ CommonMethod.getLabel(CommonMethod.responsetime),
