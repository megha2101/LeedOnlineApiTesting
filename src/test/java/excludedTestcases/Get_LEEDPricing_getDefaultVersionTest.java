...
public class Get_LEEDPricing_getDefaultVersionTest extends BaseClass{
	@Test
	@Parameters({"rowNum", "SheetName" })
	public void Get_LEEDPricing_getDefaultVersion(int rowNum, String SheetName) throws IOException {
		try {	
			...
			CommonMethod.test =  CommonMethod.extent
					.startTest("Get_LEEDPricing_getDefaultVersion Api "+ CommonMethod.getLabel(CommonMethod.responsetime),
							"Get default version.")
