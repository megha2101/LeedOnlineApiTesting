...
public class Get_LEEDPricing_getVersionsPricesInfoTest extends BaseClass{
	@Test
	@Parameters({"rowNum", "SheetName" })
	public void Get_LEEDPricing_getVersionsPricesInfo(int rowNum, String SheetName) throws IOException {
		try {	
			...
			CommonMethod.test =  CommonMethod.extent
					.startTest("Get_LEEDPricing_getVersionsPricesInfo Api "+ CommonMethod.getLabel(CommonMethod.responsetime),
