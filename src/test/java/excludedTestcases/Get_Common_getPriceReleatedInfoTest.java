...
public class Get_Common_getPriceReleatedInfoTest extends BaseClass{
	@Test
	@Parameters({"rowNum", "SheetName" })
	public void Get_Common_getPriceReleatedInfo(int rowNum, String SheetName) throws IOException {
		try {	
			...
			CommonMethod.test =  CommonMethod.extent
					.startTest("Get_Common_getPriceReleatedInfo Api "+ CommonMethod.getLabel(CommonMethod.responsetime),
