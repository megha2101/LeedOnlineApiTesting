...
public class Get_Api_getTestAccessDataTest extends BaseClass{
	@Test
	@Parameters({"rowNum", "SheetName" })
	public void Get_Api_getTestAccessData(int rowNum, String SheetName) throws IOException {
		try {	
			...
			CommonMethod.test =  CommonMethod.extent
					.startTest("Get_Api_getTestAccessData Api"+ CommonMethod.getLabel(CommonMethod.responsetime),
