...
public class Get_Files_dmsProxyTest extends BaseClass{
	@Test
	@Parameters({"rowNum", "SheetName" })
	public void Get_Files_dmsProxy(int rowNum, String SheetName) throws IOException {
		try {	
			...
			CommonMethod.test =  CommonMethod.extent
					.startTest("Get_Files_dmsProxy Api "+ CommonMethod.getLabel(CommonMethod.responseTimeInMS()),
							"File proxy related actions.")
			...
			CommonMethod.checkForSpecificSubHashMapKeyValue("paths", "download", "creditUpload");
			CommonMethod.checkforSpecificKeyValue("baseUrl", "accessKey");
