...
public class Get_Payments_getInfoTest extends BaseClass{
	@Test
	@Parameters({"rowNum", "SheetName" })
	public void Get_Payments_getInfo(int rowNum, String SheetName) throws IOException {
		try {	
			...
			CommonMethod.test =  CommonMethod.extent
					.startTest("Get_Payments_getInfo Api "+ CommonMethod.getLabel(CommonMethod.responseTimeInMS()),
			...
			CommonMethod.checkforSpecificKeyValue("processId","orderId");
			CommonMethod.checkForSpecificSubHashMapKeyValue("billTo", "firstName", "city");
