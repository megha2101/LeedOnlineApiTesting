...
public class Get_LEED_projectDownloadTest extends BaseClass{
	
	@Test
	@Parameters({"rowNum", "SheetName" })
	public void Get_LEED_projectDownload(int rowNum, String SheetName) throws IOException {
		try {	
			...
			CommonMethod.res = given().log().ifValidationFails()
					...
					//.get("/Project/download/INP/1000152064")
					.then()
					.extract()
					.response();
			...
			CommonMethod.test =  CommonMethod.extent
					.startTest("Get_LEED_projectDownload Api "+ CommonMethod.getLabel(CommonMethod.responseTimeInMS()),
