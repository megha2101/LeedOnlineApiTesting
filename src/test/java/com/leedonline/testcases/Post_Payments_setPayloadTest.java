...
public class Post_Payments_setPayloadTest extends BaseClass{
	@Test
	@Parameters({"rowNum", "SheetName" })
	public void Post_Payments_setPayload(int rowNum, String SheetName) throws IOException {
		try {	
		...
		//data.getCellData(SheetName, "payableAmount", rowNum)   
			...
			CommonMethod.test =  CommonMethod.extent
					.startTest("Post_Payments_setPayload Api"+ CommonMethod.getLabel(CommonMethod.responsetime),
