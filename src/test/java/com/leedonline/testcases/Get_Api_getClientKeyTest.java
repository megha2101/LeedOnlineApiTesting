...
public class Get_Api_getClientKeyTest extends BaseClass{

	@Test
	@Parameters({"rowNum", "SheetName" })
	public void Get_Api_getClientKey(int rowNum, String SheetName) throws IOException {
		try {	
			...
			CommonMethod.test =  CommonMethod.extent
					.startTest("Get_Api_getClientKey Api "+ CommonMethod.getLabel(CommonMethod.responseTimeInMS()),
