...
public class Get_LEED_leedOrganizationsTest extends BaseClass{
	@Test
	@Parameters({"rowNum", "SheetName" })
	public void Get_LEED_leedOrganizations(int rowNum, String SheetName) throws IOException {
		try {	
			...
			CommonMethod.test =  CommonMethod.extent
					.startTest("Get_LEED_leedOrganizations Api "+ CommonMethod.getLabel(CommonMethod.responseTimeInMS()),
